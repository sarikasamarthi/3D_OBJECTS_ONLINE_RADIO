...
//IMPLEMENTATION OF FILE->SAVE IN MENU BAR.iT WILL CALL SAVEFILE.
bool MainWindow::save() {
         
	return saveFile(curFile);
 }

/*IMPLEMENTATION OF HELP->ABOUT IN MENU BAR.ALL THESE METHODS ARE FOLLOWED FROM THE EXAMPLE MAINWINDOW APPLICATION*/
void MainWindow::about() {
    	
	QMessageBox::about(this, tr("About AssignmentI2"),
             		   tr("The <b>AssignmentI2</b> is to create "
                	   "Menu bar with File,Exit and Help menus,Docket Widget of AssignmentI1 and a texteditor. "
                	   "Menu bar and texteditor are connected."));
 }

/*ADDING ACTIONS FOR MENU BAR ITEMS. AND ADDING SOME STATUSTIP.CONNECTION BETWEEN MENU BAR ITEMS AND DISPLAY OF INFORMATION IN TEXT EDITOR IS DONE USING CONNECT MENTHOD*/
